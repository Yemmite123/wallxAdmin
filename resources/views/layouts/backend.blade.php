...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <!-- Icons -->
        <link rel="shortcut icon" href="https://api.wallx.co/img/WallX.a9443cd8.png">
        <link rel="icon" sizes="192x192" type="image/png" href="https://api.wallx.co/img/WallX.a9443cd8.png">
        <link rel="apple-touch-icon" sizes="180x180" href="https://api.wallx.co/img/WallX.a9443cd8.png">
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed main-content-narrow">
            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <!-- User Info -->
                    <div class="ml-2">
                        <a class="text-dark font-w600 font-size-sm" href="javascript:void(0)">{{session('adminfirstname')}}</a>
                    </div>
                    <!-- END User Info -->
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="/">
                        ...
                        <span class="smini-hide font-size-h5 tracking-wider">
                            <img class="img-avatar img-avatar32" src="https://api.wallx.co/img/WallX.a9443cd8.png" alt="">
                        </span>
                    </a>
                    <!-- END Logo -->
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                                ...
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('admin') ? ' active' : '' }}" href="/admin">
                                            <span class="nav-main-link-name">All Admin Users</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('pages/announcement') ? ' active' : '' }}" href="/pages/announcement">
                                            <span class="nav-main-link-name">List annoucement</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('pages/blank') ? ' active' : '' }}" href="/pages/blank">
                            ...
                            <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                    <i class="nav-main-link-icon si si-bulb"></i>
                                    <span class="nav-main-link-name">Contribution Module</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('pages/rotationalcontribution') ? ' active' : '' }}" href="/pages/rotationalcontribution">
                                            <span class="nav-main-link-name">Rotational Contribution</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('pages/quickcontribution') ? ' active' : '' }}" href="/pages/quickcontribution">
                                            <span class="nav-main-link-name">Quick Contribution</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('pages/crowdfundingcontribution') ? ' active' : '' }}" href="/pages/crowdfundingcontribution">
                                            <span class="nav-main-link-name">Crowdfunding Contribution</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                    <i class="nav-main-link-icon si si-bulb"></i>
                                    <span class="nav-main-link-name">Merchant Module</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('pages/listmerchant') ? ' active' : '' }}" href="/pages/listmerchant">
                                            <span class="nav-main-link-name">Merchant</span>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-main-item{{ request()->is('appUser/*') ? ' open' : '' }}">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                    <i class="nav-main-link-icon si si-bulb"></i>
                                    <span class="nav-main-link-name">App User Module</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('appUser/listUser') ? ' active' : '' }}" href="/appUser/listUser">
                            ...
                            <li class="nav-main-item{{ request()->is('billerModule/*') ? ' open' : '' }}">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                    <i class="nav-main-link-icon si si-bulb"></i>
                                    <span class="nav-main-link-name">Biller Module</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('billerModule/listBillMerchant') ? ' active' : '' }}" href="/billerModule/listBillMerchant">
                                            <span class="nav-main-link-name">All Biller</span>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-main-item{{ request()->is('complaint/*') ? ' open' : '' }}">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                    <i class="nav-main-link-icon si si-bulb"></i>
                                    <span class="nav-main-link-name">Complains Module</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('complaint/listComplaint') ? ' active' : '' }}" href="/complaint/listComplaint">
                                            <span class="nav-main-link-name">All Complaint</span>
                                        </a>
                                    </li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual d-flex align-items-center" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-sm-inline-block ml-2">{{session('adminfirstname')}}</span>
                                <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block ml-1 mt-1"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary-dark rounded-top">
                                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="{{ asset('media/avatars/avatar10.jpg') }}" alt="">
                                    <p class="mt-2 mb-0 text-white font-w500">{{session('adminfirstname')}} {{session('adminlastname')}}</p>
                                    <p class="mb-0 text-white-50 font-size-sm">{{session('adminrole')}}</p>
                                </div>
                                <div class="p-2">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{url('admin_profile')}}">
