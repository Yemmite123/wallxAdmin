    ...
    <div class="m-2">
        ...
        <div class="block block-rounded ">
            <div class="block-header">
                <h3 class="block-title"> All Quick Contribution</h3>
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Amount/Person</th>
                            <th class="text-center">Target</th>
                            <th class="text-center">WDL options</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if ($contribution['isflexiable'] == true)
                                    <span class="text-success"> Flexiable </span>
                                @else
                                     <span class="text-danger"> Fixed </span>
                                @endif
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                @if ($contribution['targetgoal'] == 0.0)
                                ₦0.0
                            @else
                            ₦{{number_format(substr($contribution['targetgoal'],0,-1) )}}
                            @endif
                            
                            </td>
                            <td> 
                                @foreach ($contribution['withdrawaloptions'] as $item)
                                {{$item}}
                                @endforeach
